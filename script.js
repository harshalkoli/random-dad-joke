...
const randomInt = getRandomInteger(0, 14);
let randomjoke = dadJokes[randomInt];

let element = document.getElementById("joke");
element.innerHTML = dadJokes[randomInt].question;

let element2 = document.getElementById("answer");
element2.innerHTML = dadJokes[randomInt].answer;
